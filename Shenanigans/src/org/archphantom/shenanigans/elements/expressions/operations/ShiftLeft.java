...
public class ShiftLeft extends Expression {
	private static final long serialVersionUID = 1885480096964567811L;
	...
	public IntValue evaluate (VarTable vars, Program program) {
		...
		return new IntValue ((((IntValue) aval).intValue(vars, program)).shiftLeft(((IntValue) bval).intValue(vars, program).intValue()));
	}
